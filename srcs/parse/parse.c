...
/*   Updated: 2023/01/11 18:05:47 by jraivio          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	parse(void)
{
	...
	get_scene()->shapes[0].object.location = (t_vector){.x = 0, .y = 0, .z = 450};
	...
	get_scene()->shapes[1].object.location = (t_vector){.x = 20, .y = 0, .z = 100};
	...
	get_scene()->shapes[2].object.location = (t_vector){.x = -20, .y = 0, .z = 100};
